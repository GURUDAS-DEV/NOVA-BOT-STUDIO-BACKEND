export const buildScrapingDoneEmail = (url: string): string => {
	return `<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8" />
			...
			<tr>
				<td align="center">
					<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; background:#ffffff; border-radius:12px; box-shadow:0 6px 18px rgba(24,39,75,0.08); overflow:hidden;">
						<tr>
							<td style="padding:28px 32px; background:#0f1b2d; color:#ffffff;">
								<div style="font-size:18px; font-weight:700; letter-spacing:0.3px;">Nova Bot Studio</div>
								<div style="font-size:13px; opacity:0.8; margin-top:6px;">Scraping Completed</div>
							</td>
						</tr>
						<tr>
							<td style="padding:28px 32px;">
								<h1 style="margin:0 0 12px; font-size:22px;">Your website scraping is complete</h1>
								<p style="margin:0 0 18px; font-size:14px; line-height:1.6; color:#3a3a3a;">
									We have successfully finished scraping the URL you provided. You can now proceed with the next steps in Nova Bot Studio.
								</p>
								...
								<p style="margin:18px 0 0; font-size:12px; color:#6b7280;">
									If you did not request this scraping, please contact support.
								</p>
							</td>
						</tr>
						<tr>
